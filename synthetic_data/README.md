...
The [`data_utils.py`](./data_utils.py) and [`network_def.py`](./network_def.py) modules include all the necessary imports, while [`train_model.py`](./train_model.py) is the script that actually trains a model, given a config file.
